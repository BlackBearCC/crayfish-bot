...
${formatHelpExamples([
  ...
  [
    "openclaw agents set-identity --workspace ~/.petclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "openclaw agents set-identity --identity-file ~/.petclaw/workspace/IDENTITY.md --agent main",
