...
const AUTH_CHOICE_GROUP_DEFS: {
  ...
  },
  {
    value: "doubao",
    label: "Doubao (豆包)",
    hint: "Volcengine API (DeepSeek/Doubao models)",
    choices: ["doubao-api-key"],
  },
  {
    value: "qwen-api",
    label: "Qwen API (通义千问)",
    hint: "Alibaba Cloud API key",
    choices: ["qwen-api-key"],
  },
];
...
export function buildAuthChoiceOptions(params: {
  ...
  options.push({
    ...
    label: "Doubao (豆包) API key",
    hint: "Volcengine API (DeepSeek/Doubao models)",
  });
  options.push({
    value: "qwen-api-key",
    label: "Qwen API key (通义千问)",
    hint: "Alibaba Cloud DashScope API",
  });
